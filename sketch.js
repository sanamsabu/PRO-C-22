...
function setup(){
    ...
    redBox = Bodies.rectangle(156,320,100,120,redBox_options);
    ...
    greenBox = Bodies.rectangle(350,320,100,120,greenBox_options);
    ...
    ball = Bodies.circle(560,200,20, ball_options);
